...
<head>
    ...
    <!-- Title  -->
    <title>{{ config('app.name', 'Search Result| Joy Cosmetics') }}</title>
    <!-- Favicon -->
...
<body>
    ...
    <div class="products-catagories-area clearfix">
        <h4 align="center" style="margin: 1em; font-weight: bolder;">Search results for "{{$search}}"</h4>
        <hr>
        ...
        <div class="amado-pro-catagory clearfix">
            ...
            @empty
            <h6 align="center">No result found</h6>
            @endforelse
